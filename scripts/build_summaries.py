...
SEASON = os.path.join(DATA, "season")
...
def head_dict(df: pd.DataFrame, n=5) -> list[dict]:
...
players_hist, a = load_csv(os.path.join(DATA, "players_raw_history.csv"))
anomalies += a

pcf, a = load_csv(os.path.join(DATA, "price_change_forecast.csv"))
anomalies += a

pcf_hist, a = load_csv(os.path.join(DATA, "price_change_forecast_history.csv"))
anomalies += a

fixtures, a = load_csv(os.path.join(DATA, "fixtures.csv"))
anomalies += a

deadlines, a = load_csv(os.path.join(DATA, "deadlines.csv"))
anomalies += a

merged_gw, a = load_csv(os.path.join(DATA, "merged_gw.csv"))
anomalies += a
